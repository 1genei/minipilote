                            ...
                            <tbody>
                                @foreach ($contactentites as $contactentite)
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         @if($contactentite->est_prospect == true) <span class="badge bg-secondary">Prospect</span> @endif
                                         @if($contactentite->est_client == true) <span class="badge bg-primary">Client</span> @endif
                                         @if($contactentite->est_fournisseur == true) <span class="badge bg-danger">Fournisseur</span> @endif
                                     ...
                                     <td>
                                        ...
                                        <a data-href="{{route('contact.update', $contactentite->id)}}" 
                                            ...
                                            data-est-prospect="{{$contactentite->est_prospect}}" data-est-client="{{$contactentite->est_client}}" data-est-fournisseur="{{$contactentite->est_fournisseur}}" 
