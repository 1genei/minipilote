        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <div class="row mb-2">
                     <div class="col-sm-5">
                         <a href="javascript:void(0);" class="btn btn-primary mb-2"  data-bs-toggle="modal" data-bs-target="#standard-modal"><i class="mdi mdi-plus-circle me-2"></i> Nouveau contact</a>
                     </div>
                     <div class="col-sm-7">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="standard-modalLabel">Ajouter un contact</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="email" name="email" value="{{old('email') ? old('email') : ''}}" class="form-control" id="floatingInput" required >
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="nom" value="{{old('nom') ? old('nom') : ''}}" class="form-control" id="floatingInput" required >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mt-2">
                                    <div class="form-check form-check-inline form-checkbox-secondary">
                                        <input type="checkbox" name="prospect" class="form-check-input" id="edit-prospect" disabled>
                                        <label class="form-check-label"  for="edit-prospect">Prospect</label>
                                    </div>
                                    <div class="form-check form-check-inline form-checkbox-success">
                                        <input type="checkbox" name="client" class="form-check-input " id="edit-client" disabled>
                                        <label class="form-check-label"  for="edit-client">Client</label>
                                    </div>
                                    <div class="form-check form-check-inline form-checkbox-danger">
                                        <input type="checkbox" name="fournisseur" class="form-check-input " id="edit-fournisseur" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="nom" value="{{old('nom') ? old('nom') : ''}}" class="form-control" id="edit-nom" required >
                                    <label for="floatingInput">Nom</label>
                                    @if ($errors->has('nom'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="tel" name="contact1" value="{{old('contact1') ? old('contact1') : ''}}" class="form-control" id="edit-contact1" >
                                    <label for="floatingInput">Téléphone1</label>
                                    @if ($errors->has('contact1'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="tel" name="contact2" value="{{old('contact2') ? old('contact2') : ''}}" class="form-control" id="edit-contact2" >
                                    <label for="floatingInput">Téléphone2</label>
                                    @if ($errors->has('contact2'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="tel" name="adresse" value="{{old('adresse') ? old('adresse') : ''}}" class="form-control" id="edit-adresse" >
                                    <label for="floatingInput">Adresse</label>
                                    @if ($errors->has('adresse'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="tel" name="code_postal" value="{{old('code_postal') ? old('code_postal') : ''}}" class="form-control" id="edit-code_postal" >
                                    <label for="floatingInput">Code postal</label>
                                    @if ($errors->has('code_postal'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="tel" name="ville" value="{{old('ville') ? old('ville') : ''}}" class="form-control" id="edit-ville" >
                                    <label for="floatingInput">Ville</label>
                                    @if ($errors->has('ville'))
                                        <br>
                                        <div class="alert alert-warning text-secondary " role="alert">
