                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" name="email"
                                            value="{{ old('email') ? old('email') : $contact->individu->email }}"
                                            class="form-control" id="edit-email" required>
                                ...
                                <div class="col-12">
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline form-checkbox-secondary">
                                            <input type="checkbox" name="prospect" class="form-check-input"
                                                id="edit-prospect" @if ($contact->est_prospect) checked @endif
                                                disabled>
                                        ...
                                        <div class="form-check form-check-inline form-checkbox-success">
                                            <input type="checkbox" name="client" class="form-check-input "
                                                id="edit-client" @if ($contact->est_client) checked @endif disabled>
                                            <label class="form-check-label" for="edit-client">Client</label>
                                        </div>
                                        <div class="form-check form-check-inline form-checkbox-danger">
                                            <input type="checkbox" name="fournisseur" class="form-check-input "
                                                id="edit-fournisseur" @if ($contact->est_fournisseur) checked @endif
                                                disabled>
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nom"
                                            value="{{ old('nom') ? old('nom') : $contact->individu->nom }}"
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="prenom"
                                            value="{{ old('prenom') ? old('prenom') : $contact->individu->nom }}"
                                            class="form-control" id="edit-prenom" required>
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="contact1"
                                            value="{{ old('contact1') ? old('contact1') : $contact->individu->contact1 }}"
                                            class="form-control" id="edit-contact1">
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="contact2"
                                            value="{{ old('contact2') ? old('contact2') : $contact->individu->contact2 }}"
                                            class="form-control" id="edit-contact2">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="adresse"
                                            value="{{ old('adresse') ? old('adresse') : $contact->individu->adresse }}"
                                            class="form-control" id="edit-adresse">
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="code_postal"
                                            value="{{ old('code_postal') ? old('code_postal') : $contact->individu->code_postal }}"
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="ville"
                                            value="{{ old('ville') ? old('ville') : $contact->individu->ville }}"
                                            class="form-control" id="edit-ville">
