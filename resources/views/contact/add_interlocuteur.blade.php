                ...
                <div class="modal-body">
                    ...
                    <div class="nouveau_contact">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3 ">
                                    <label for="emailx" class="form-label">
                                        Email <span class="text-danger">*</span>
                                    </label>
                                    <input type="email" id="emailx" name="emailx"
                                        value="{{ old('emailx') ? old('emailx') : '' }}" class="form-control">
                                    ...
                                    @if ($errors->has('emailx'))
                                        ...
                                        <div class="alert alert-warning text-secondary " role="alert">
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                            <strong>{{ $errors->first('emailx') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
