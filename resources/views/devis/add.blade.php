                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-4 ">
                                                        ...
                                                        <input type="number" id="numero_devis" name="numero_devis" min="{{$prochain_numero_devis}}"
                                                            value="{{$prochain_numero_devis}}" class="form-control" style="font-size: 1.3rem;color: #772e7b; " required>
                                                    ...
                                                    <div class="col-md-4 ">
                                                        ...
                                                        <input type="text" id="nom_devis" name="nom_devis" style="font-size: 1.3rem;color: #772e7b;"
