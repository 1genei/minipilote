...
<head>
    ...
    <link href="{{ asset('assets/css/quill.snow.css') }}" rel="stylesheet" type="text/css" id="app-style" />
    <link href="{{ asset('assets/css/quill.core.css') }}" rel="stylesheet" type="text/css" id="app-style" />
