                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                                @can('permission', 'archiver-voiture')
                                    <a href="{{ route('voiture.index') }}" class="btn btn-success mb-2">
                                        <i class="mdi mdi-archive me-2"></i> Voitures actives
                                    </a>
                                @endcan
                            </div>
                        </div>
                    ...
                    <form action="{{ route('voiture.store') }}" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="prix_kilometrique" value="{{ old('prix_kilometrique') ? old('prix_kilometrique') : '' }}"
                                            class="form-control" id="floatingInput">
                                        <label for="floatingInput">Prix kilométrique</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_pneu" value="{{ old('seuil_alerte_km_pneu') ? old('seuil_alerte_km_pneu') : '' }}"
                                            class="form-control" id="floatingInput">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_vidange" value="{{ old('seuil_alerte_km_vidange') ? old('seuil_alerte_km_vidange') : '' }}"
                                            class="form-control" id="floatingInput">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_revision" value="{{ old('seuil_alerte_km_revision') ? old('seuil_alerte_km_revision') : '' }}"
                                            class="form-control" id="floatingInput">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_courroie" value="{{ old('seuil_alerte_km_courroie') ? old('seuil_alerte_km_courroie') : '' }}"
                                            class="form-control" id="floatingInput">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_frein" value="{{ old('seuil_alerte_km_frein') ? old('seuil_alerte_km_frein') : '' }}"
                                            class="form-control" id="floatingInput">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="seuil_alerte_km_amortisseur" value="{{ old('seuil_alerte_km_amortisseur') ? old('seuil_alerte_km_amortisseur') : '' }}"
                                            class="form-control" id="floatingInput">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="prix_kilometrique" value="{{ old('prix_kilometrique') ? old('prix_kilometrique') : '' }}"
                                            class="form-control" id="edit_prix_kilometrique">
