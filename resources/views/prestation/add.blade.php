            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Formulaire de d'ajout de la prestation --}}
                                    ...
                                    <div class="col-4 offset-4 ">
                                        <div class="mb-3 ">
                                            ...
                                            <input type="number" id="numero" name="numero"
                                                min="{{ $prochain_numero_prestation }}"
                                                value="{{ $prochain_numero_prestation }}" class="form-control"
                                    ...
                                    <div class="col-6 ">
                                        <div class="mb-3 ">
                                            ...
                                            <input type="number" id="montant_ttc" name="montant_ttc" step="0.01"
                                                value="{{ old('montant_ttc') ? old('montant_ttc') : '' }}"
                                    ...
                                    <div class="col-6 ">
                                        <div class="mb-3 ">
                                            ...
                                            <input type="date" id="date_prestation" name="date_prestation"
                                                value="{{ old('date_prestation') ? old('date_prestation') : '' }}"
                                                class="form-control">
