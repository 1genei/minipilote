            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="categorie_id" class="form-label">xxxxxxxxxxxxx</label>
                            ...
                            <div class="col-lg-12">
                                <div class="col-12">
                                    <label for="nom" id="tooltip-prix"
                                        ...
                                        <i class=" mdi mdi-information text-primary "
                                            data-bs-container="#tooltip-prix" data-bs-toggle="tooltip"
                                            data-bs-placement="right" title="Prix d'achat affiché au commercial"></i>
                                    </label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-lg-6 col-xxl-4 mb-3">
                                        ...
                                        <input type="number" step="0.001" min="0" class="form-control"
                                            name="prix_achat_commerciaux_ht"
                                    ...
                                    <div class="col-sm-6 col-lg-6 col-xxl-4 mb-3">
                                        ...
                                        <input type="number" step="0.001" min="0" class="form-control"
                                            name="prix_achat_commerciaux_ttc" id="prix_achat_commerciaux_ttc"
                            ...
                            <div class="col-lg-12 div_stock">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-xxl-4 mb-3">
                                        ...
                                        <input type="number" min="0" class="form-control" name="quantite"
                                    ...
                                    <div class="col-sm-6 col-xxl-4 mb-3">
                                        ...
                                        <label for="quantite_min_vente" class="form-label">Quantité minimale pour la
                                            vente </label>
                                        <input type="number" min="0" class="form-control"
                                            name="quantite_min_vente"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <input type="number" min="0" class="form-control"
                                            placeholder="Laisser vide pour désactiver" name="seuil_alerte_stock"
