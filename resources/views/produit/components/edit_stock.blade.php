        ...
        <div class="col-lg-6">
            <div class="col-12">
                <label for="nom" id="tooltip-prix" class="form-label fs-5 mb-2 text-bold">Quantités
                    <i class=" mdi mdi-information text-primary " data-bs-container="#tooltip-prix"
                        data-bs-toggle="tooltip" data-bs-placement="right" title="Quantité du produit en stock"></i>
                </label>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xxl-4 mb-3">
                    ...
                    <input type="number" min="0" class="form-control" wire:model.defer="quantite"
                        name="quantite" value="{{ old('quantite') }}" id="quantite">
