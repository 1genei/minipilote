                                ...
                                <div class="collapse show mt-3" id="modeleTasks">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-2" style="margin-left: 20px;">
                                                <div class="form-check">
                                                    <input type="radio" id="edit_modele_aucun" name="modelevoiture_id" value="" class="form-check-input check-decli">
                                                    <label class="form-check-label" for="edit_modele_aucun">Aucun</label>
                                                </div>
                                                @foreach ($modelevoitures as $modele)
                                                    <div class="form-check">
                                                        <input type="radio" id="edit_modele_{{ $modele->id }}"
                                                            name="modelevoiture_id"
                                                            value="{{ $modele->id }}" class="form-check-input">
                                                        <label class="form-check-label"
                                                            for="edit_modele_{{ $modele->id }}">{{ $modele->nom }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="collapse show mt-3" id="circuitTasks">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-2" style="margin-left: 20px;">
                                                <div class="form-check">
                                                    <input type="radio" id="edit_circuit_aucun" name="circuit_id" value="" class="form-check-input check-decli">
                                                    <label class="form-check-label" for="edit_circuit_aucun">Aucun</label>
                                                </div>
                                                @foreach ($circuits as $circuit)
                                                    <div class="form-check">
                                                        <input type="radio" id="edit_circuit_{{ $circuit->id }}"
                                                            name="circuit_id"
                                                            value="{{ $circuit->id }}" class="form-check-input">
                                                        <label class="form-check-label"
                                                            for="edit_circuit_{{ $circuit->id }}">{{ $circuit->nom }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
