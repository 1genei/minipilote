                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                                @can('permission', 'archiver-produit')
                                    <a href="{{ route('produit.index') }}" class="btn btn-success mb-2">
                                        <i class="mdi mdi-archive me-2"></i> Produits actifs
                                    </a>
                                @endcan
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <livewire:produit.archive-table />
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $(function() {
            ...
            $('body').on('click', 'a.unarchive_produit', function(event) {
                let that = $(this)
