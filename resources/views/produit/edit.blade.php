            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <livewire:produit.edit-form :produit="$produit" :categories="$categories" :caracteristiques="$caracteristiques" :marques="$marques" :tvas="$tvas" :circuits="$circuits" :modelevoitures="$modelevoitures">
