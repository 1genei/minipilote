                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-sm-2 mr-14 ">
                            <a href="{{route('agenda.index')}}" type="button" class="btn btn-danger"><i class="uil-calendar-alt"></i> Affichage sur le calendrier</a>
                        </div>
                        @if(session('ok'))
                        <div class="col-6">
                            ...
                            <div class="media">
                                ...
                                <div style="display:flex; flex-direction: row; justify-content:space-around; ">
                                    ...
                                    <div class="media-left media-middle">
                                        <i class="ti-list f-s-48 color-primary m-r-1"></i> <label for="" ><a style="font-weight: bold; color:#2483ac; font-size:18px " href="{{route('agenda.listing')}}">Toutes les tâches 
