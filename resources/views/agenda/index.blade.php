...
<div class="content">
                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-sm-2 mr-14 ">
                            <a href="{{route('agenda.listing')}}" type="button" class="btn btn-danger"><i class="uil-grid"></i> Affichage dans un tableau</a>
                        </div>
                        @if(session('ok'))
                        <div class="col-6">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="d-grid">
                                <button class="btn btn-lg font-16 btn-primary"  data-bs-toggle="modal" data-bs-target="#new-event" ><i class="mdi mdi-plus-circle-outline"></i> Créer nouvelle tâche</button>
                            </div>
        ...
        {{-- Ajout d'une tâche --}}
        <div id="new-event" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 div_contact">
                                    <div class="form-floating mb-3" style="width: 100%;">
                                        <select name="contact_id" id="contact_id" class="selectpicker " data-live-search="true" >    
        ...
        <div id="event-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="" id="form-edit" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 div_contact">
                                    <div class="form-floating mb-3" style="width: 100%;">
                                        <select name="contact_id" id="edit_contact_id" class="selectpicker " data-live-search="true" >    
                                        <option value="">Choisir le contact</option>
                                        @foreach ($contacts as $contact )
                                            <option  data-tokens="@if($contact->type == "individu"){{$contact->individu->nom}} {{$contact->individu->prenom}}  @else  {{$contact->entite->nom}} @endif" value="{{$contact->id}}">  @if($contact->type == "individu"){{$contact->individu->nom}} {{$contact->individu->prenom}}  @else  {{$contact->entite->nom}} @endif</option>                                    
...
!(function (e) {
    ...
    (t.prototype.onEventClick = function (t) {
        ...
        this.$formEvent[0].reset(),
            ...
            e('#edit_type_rappel option[value='+this.$selectedEvent.extendedProps.type_rappel+']').attr('selected','selected');
    ...
    (t.prototype.init = function () {
        ...
        var val;
                 ...
                 agendas.forEach( function (agenda)  {
                    ...
                    if(agenda.est_terminee == true){
                        ...
                        var title = agenda.est_lie == true ? tab_contacts[agenda.contact_id]["nom"] : agenda.titre;
                        ...
                        val = {
                            ...
                            contact: tab_contacts[agenda.contact_id] ? tab_contacts[agenda.contact_id]["contact"] : "",                           
                            nom_contact: tab_contacts[agenda.contact_id] ? tab_contacts[agenda.contact_id]["nom"] : "",
        ...
        a.$calendarObj.render(),
            ...
            a.$formEvent.on("submit", function (t) {
                ...
                l.checkValidity() ?
                    (a.$selectedEvent ?
                        (a.$selectedEvent.setProp("title", e("#edit_titre").val()), a.$selectedEvent.setProp("classNames", [e("#edit_description").val()])) :
                        ((n = {
