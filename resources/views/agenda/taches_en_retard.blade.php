                                        ...
                                        <div style="display:flex; flex-direction: row; justify-content:space-around; ">
                                            ...
                                            <div class="media-left media-middle">
                                                <i class="ti-list f-s-48 color-danger m-r-1"></i> <label for=""><a
                                                        style="font-weight: bold; color:#8b0f06;font-size:18px "
                                    ...
                                    <div class="form-floating mb-3" style="width: 100%;">
                                        <select name="contact_id" id="edit-contact-id" class="selectpicker"
                                            ...
                                            @foreach ($contacts as $contact)
                                                <option
                                                    data-tokens="@if ($contact->type == 'individu') {{ $contact->infos()?->nom }} {{ $contact->infos()?->nom }}  @else  {{ $contact->infos()?->nom }} @endif"
                                                    value="{{ $contact->id }}">
                                                    @if ($contact->type == 'individu')
                                                        {{ $contact->infos()?->nom }} {{ $contact->infos()?->nom }}
                                                    @else
                                                        {{ $contact->infos()?->nom }}
                                                    @endif
                                                </option>
