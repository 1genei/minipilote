                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-sm-2 mr-14 ">
                            <a href="{{route('permission.index')}}" type="button" class="btn btn-outline-primary"><i class="uil-arrow-left"></i> Affichage sur l'agenda</a>
                        </div>
                        @if(session('ok'))
                        <div class="col-6">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <div class="row mb-2">
                     <div class="col-sm-5">
                         <a href="javascript:void(0);" class="btn btn-primary mb-2"  data-bs-toggle="modal" data-bs-target="#standard-modal"><i class="mdi mdi-plus-circle me-2"></i> Nouvelle tâche</a>
                     </div>
                     <div class="col-sm-7">
                            ...
                            <div class="media">
                                ...
                                <div style="display:flex; flex-direction: row; justify-content:space-around; ">
                                    <div class="media-left media-middle">                       
                                        <i class="ti-list f-s-48 color-danger m-r-1"></i> <label for="" ><a style="font-weight: bold; color:#8b0f06;font-size:18px " href="{{route('agenda.listing_en_retard')}}">Tâches en retard 
                                            <span class="badge badge-danger">{{\App\Models\Agenda::nb_taches("en_retard")}}</span>
                                        </a></label>  <hr style="border-top: 5px solid #240c9a; margin-top: 10px">                    
                                    </div>
                                    
                                    <div class="media-left media-middle">
                                        <i class="ti-list f-s-48 color-primary m-r-1"></i> <label for="" ><a style="font-weight: bold; color:#2483ac; " href="{{route('agenda.listing')}}">Toutes les tâches 
                                            <span class="badge badge-danger">{{\App\Models\Agenda::nb_taches("toutes")}}</span> 
                                        </a></label>                  
                                    </div>
                                    
                                    <div class="media-left media-middle">
                                        <i class="ti-list f-s-48 color-success m-r-1"></i> <label for="" ><a style="font-weight: bold; color:#14893f;" href="{{route('agenda.listing_a_faire')}}">Tâches à faire
                                            <span class="badge badge-danger">{{\App\Models\Agenda::nb_taches("a_faire")}}</span>
                                        </a></label>                    
                                    </div>
                                                    ...
                                                    @foreach ($agendas as $agenda)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="color: #450854; ">
                                                                   <span> @if($agenda->user != null) {{$agenda->user->name}} @endif </span>  
                                                                </td>
                                                                                        
                                                                <td style="color: #450854; "> 
                                                                    <span> @if($agenda->est_lie == true && $agenda->contact )                                                                    
                                                                ...
                                                                <td style="color: #450854; ">
                                                                    <p class="media-heading">{{$agenda->type_rappel}} </p>
                                                                </td>
                                                                <td >
                                                                    <p style="color: #e05555; font-weight:bold; ">{{$agenda->titre}} </p> <p>  <i>{{$agenda->description}} </i>  </p> 
                                                                </td>
                                                                ...
                                                                <td style="color: #32ade1;">
                                                                    ...
                                                                    @endphp
                                                                   <p class="" style="font-weight: bold;">{{$date_deb->format('d/m/Y')}} à {{$agenda->heure_deb}}</p>
                                                                </td>
                                                                
                                                                <td style="color: #32ade1;">
                                                                    <div class="comment-action">
                                                                        @if($agenda->est_terminee == true )
                                                                           <div class="badge bg-success">Terminée</div>
                                                                        @else 
                                                                           <div class="badge bg-danger">Non Terminée</div>
                                                                        @endif                                                                        
                                                                     </div>
                                                                ...
                                                                <td>
                                                                    <a  data-href="{{route('agenda.update',$agenda->id)}}"  href="javascript:void(0);"
                                                                        data-titre="{{$agenda->titre}}" data-description="{{$agenda->description}}" data-date_deb="{{$agenda->date_deb->format('Y-m-d')}}"  data-date_fin="{{$agenda->date_fin->format('Y-m-d')}}" 
                                                                        data-heure_deb="{{$agenda->heure_deb}}" data-type="{{$agenda->type_rappel}}" data-est_lie="{{$agenda->est_lie}} " data-contact_id="{{$agenda->contact_id}}" 
                                                                        title="@lang('Modifier ')" title="@lang('modifier la tâche ') " 
                                                                        class="modifier text-success"  data-bs-toggle="modal" data-bs-target="#modifier-modal"><i class="mdi mdi-circle-edit-outline"></i>
                                                                    </a>
                                                                    <span><a  href="javascript:void(0);"  data-href="{{route('agenda.destroy',$agenda->id)}}" class="delete text-danger" data-toggle="tooltip" title="@lang('Supprimer la tâche') "><i class="mdi mdi-delete-circle-outline"></i> </a></span>
                                                                </td>
...
<style>
    ...
    .btn-light {
        ...
        <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                    ...
                    <form action="{{route('agenda.store')}}" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" min="{{date('Y-m-d')}}" name="date_deb" value="{{old('date_deb') ? old('date_deb') : ''}}" class="form-control" id="date_deb" required >
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" min="{{date('Y-m-d')}}" name="date_fin" value="{{old('date_fin') ? old('date_fin') : ''}}" class="form-control" id="date_fin" required >
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="time"  name="heure_deb" min="06:00" max="23:00" value="{{old('heure_deb') ? old('heure_deb') : ''}}" class="form-control" id="heure_deb" required >
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 div_contact">
                                    <div class="form-floating mb-3" style="width: 100%;">
                                        <select name="contact_id" id="edit-contact-id" class="selectpicker" data-live-search="true" >    
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="titre" value="{{old('titre') ? old('titre') : ''}}" class="form-control" id="titre" >
         ...
         <div id="modifier-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="" id="form-edit" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" min="{{date('Y-m-d')}}" name="date_deb" value="{{old('date_deb') ? old('date_deb') : ''}}" class="form-control" id="edit_date_deb" required >
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" min="{{date('Y-m-d')}}" name="date_fin" value="{{old('date_fin') ? old('date_fin') : ''}}" class="form-control" id="edit_date_fin" required >
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <input type="time"  name="heure_deb" min="06:00" max="23:00" value="{{old('heure_deb') ? old('heure_deb') : ''}}" class="form-control" id="edit_heure_deb" required >
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 div_contact">
                                    <div class="form-floating mb-3" style="width: 100%;">
                                        ...
                                        <option value="">Choisir le contact</option>
                                        @foreach ($contacts as $contact )
                                            <option  value="{{$contact->id}}">  @if($contact->type == "individu"){{$contact->individu->nom}} {{$contact->individu->prenom}}  @else  {{$contact->entite->nom}} @endif</option>                                    
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="titre" value="{{old('titre') ? old('titre') : ''}}" class="form-control" id="edit_titre" >
