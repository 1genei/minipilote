            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h4 class="mb-0 mt-2">{{ $evenement->nom }} 
                        ...
                        @else
                            <span class="text-primary"> {{ $evenement->date_debut->format('d/m/Y') }} - {{ $evenement->date_fin->format('d/m/Y') }} </span>
                        @endif
                        <a href="{{ route('evenement.edit', Crypt::encrypt($evenement->id)) }}" class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a>
                    </h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center ">
                        <h4 class="header-title">Circuit: <span class="text-muted"> {{ $evenement->circuit?->nom }} </span> </h4>
                        <div class="dropdown">
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                        ...
                        <li class="nav-item">
                            <a href="#prestation" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0 active">
                                Prestations
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane " id="charge">
                            ...
                            data-bs-toggle="modal" data-bs-target="#standard-modal"><i
                                class="mdi mdi-account-plus me-1"></i> <span>Ajouter charge</span>
                            </button> <hr>
