            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ $planning->nom }}</li>
                    </ol>
                </div>
                <h2 class="page-title">
                    {{ $planning->nom }}
                    @if($planning->date)
                        <small class="text-muted fs-5 ms-2">— {{ \Carbon\Carbon::parse($planning->date)->format('d/m/Y') }}</small>
                    @endif
                    @if($planning->circuit)
                        <small class="text-muted fs-5 ms-2">— {{ $planning->circuit->nom }}</small>
                    @endif
                </h2>
            </div>
        </div>
        ...
        @php
            ...
            for ($hour = $heureDebut; $hour <= $heureFin; $hour++) {
                ...
                while ($minute < 60) {
                    ...
                    $isPause = $planning->a_pause
                        && $planning->heure_debut_pause
                        && $planning->heure_fin_pause
                        && $slotTime >= $planning->heure_debut_pause
