                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="description" rows="2" placeholder="Description de la commande...">{{ old('description', $commande->description) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="preference_roulage" rows="2" placeholder="Préférences ou consignes de roulage...">{{ old('preference_roulage', $commande->preference_roulage) }}</textarea>
                                        </div>
                                    </div>
