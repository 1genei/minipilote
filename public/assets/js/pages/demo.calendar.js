!(function (e) {
    ...
    (t.prototype.onEventClick = function (t) {
        this.$formEvent[0].reset(),
            ...
            e("#event-title").val(this.$selectedEvent.title),
    ...
    (t.prototype.init = function () {
        ...
        a.$calendarObj.render(),
            ...
            a.$formEvent.on("submit", function (t) {
                ...
                l.checkValidity() ?
                    (a.$selectedEvent ?
                        (a.$selectedEvent.setProp("title", e("#event-title").val()), a.$selectedEvent.setProp("classNames", [e("#event-category").val()])) :
                        ((n = {
                            title: e("#event-title").val(),
                            start: a.$newEventData.date,
                            allDay: a.$newEventData.allDay,
                            className: e("#event-category").val()
