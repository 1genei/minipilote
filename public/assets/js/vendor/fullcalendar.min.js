...
var FullCalendar = (function (e) {
    ...
    function ar(e, t, n, r, o, i, a) {
        ...
        return u && !d.allDay && (m || y) ?
            ((v = m ? f : v), (g = y ? h : g), c && d.hasEnd ? s.formatRange(v, g, t, {
            ...
            return (
                ...
                (t.prototype.renderInnerContent = function () {
                    ...
                    return (
                        ...
                        (e && (e.destroy && e.destroy(), (e = this.customContentInfo = null)), n.contentKey && (e = this.customContentInfo = r({
            ...
            return (
                ...
                (e.prototype.drain = function () {
                    for (var e = this.queue; e.length;) {
                        for (var t = [], n = void 0;
                            (n = e.shift());) this.runTask(n), t.push(n);
                        this.drained(t);
                    }
                }),
            ...
            return (
                ...
                (e.prototype.splitEntry = function (e, t, n) {
                    var r = 0,
                        ...
                        s = t.span;
                    return (
                        a.start < s.start && (r += this.insertEntry({
                            index: e.index,
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || (d.editable && d.droppable) ?
                            ...
                            ((l = Sr(n, a.getCurrentData().eventUiBases, s, a)), (c.mutatedEvents = l), Ia(c, e.dateProfile, a) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = {
                                defs: {},
                                instances: {}
                            }))) :
                            (a = null);
                    ...
                    return _o(us, {
                        ...
                        return _o(
                            ...
                            _o(
                                ...
                                }, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")),
                                _o("div", {
