    ...
    public function addColumns(): PowerGridColumns
    {
        ...
        return PowerGrid::columns()
            ...
            ->addColumn('numero', function (Prestation $model) {          
                return  '<span class="badge bg-warning text-white font-bold py-1 px-2 fs-6">'.$model->numero.'</span>';
       ...
       return [
        ...
        //        }),
            ...
            ->bladeComponent('button-archive', function(Prestation $prestation) {
                return ['route' => route('prestation.unarchive', Crypt::encrypt($prestation->id)),
                'tooltip' => "Désarchiver",
                'classarchive' => "unarchive_prestation",
                'permission' => Gate::allows('permission', 'modifier-contact'),
