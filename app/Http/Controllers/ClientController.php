...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        $contactentites = Contact::where([["type","entite"], ['archive', false],['est_client', true]])->get();
        $contactindividus = Contact::where([["type","individu"], ['archive', false],['est_client', true]])->get();

        return view('client.index', compact('contactentites', 'contactindividus'));
    }
